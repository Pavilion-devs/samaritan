...
- [x] Dashboard judge surface implemented with the approved editorial Overview, Live Match, Decisions, and Performance, plus the evidence-dense Proof route in [`docs/UI.md`](docs/UI.md); captured, historical, synthetic, paper, and unanchored states remain visibly separated.
