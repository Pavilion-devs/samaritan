...
- [x] Dashboard judge surface implemented with the approved editorial Overview plus evidence-dense Matchroom, Decision Rail, Decisions, Performance, and Proof routes in [`docs/UI.md`](docs/UI.md); captured, historical, synthetic, paper, and unanchored states remain visibly separated.
