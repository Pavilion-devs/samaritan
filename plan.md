...
- [x] Dashboard judge surface implemented with the complete approved editorial Overview, Live Match, Decisions, Performance, and Proof system in [`docs/UI.md`](docs/UI.md); captured, historical, synthetic, paper, local-verification, and unanchored states remain visibly separated.
